...
<p class="codeterm" style="color:red">NOT NULL</p>해당 필드에 NULL 값을 저장할 수 없게 하는 옵션이다.
<p class="codeterm" style="color:red">UNIQUE</p>해당 필드는 반드시 서로 다른 값을 갖게 하는 옵션이다.
<p class="codeterm" style="color:red">PRIMARY KEY</p>해당 필드가 NOT NULL과 UNIQUE  2가지 제약 조건의 특징을 모두 갖게 하는 옵션이다.
<p class="codeterm" style="color:red">FOREIGN KEY</p>하나의 테이블이 다른 테이블에 의존하게 만드는 옵션이다.
<p class="codeterm" style="color:red">DEFAULT</p>필드의 기본값을 설정하는 옵션이다.
<br>
